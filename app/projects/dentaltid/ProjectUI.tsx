...
const STYLES: StylesConfig = {"heroTitleSize":120,"buttonPaddingX":64,"buttonPaddingY":32,"buttonTextSize":32,"sectionSpacing":20,"borderRadius":32,"brandLogo":"logo.png","heroBackground":"","heroImgWidth":100,"heroImgOffsetY":0,"heroImgScale":100,"heroVideoWidth":1366,"heroVideoHeight":768};
...
export default function ProjectUI() {
    ...
    <section key={0} style={{ paddingTop: '20px', paddingBottom: '20px' }} className="space-y-20">
    ...
    <section key={1} style={{ paddingTop: '20px', paddingBottom: '20px' }} className="space-y-20">
      <div className="max-w-6xl mx-auto text-center space-y-10">
    ...
    <section key={2} style={{ paddingTop: '20px', paddingBottom: '20px' }} className="space-y-20">
      <div className="max-w-6xl mx-auto text-center space-y-10">
