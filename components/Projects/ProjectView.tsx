            ...
            <main className="relative z-10 w-full">
                ...
                <section className="pt-20 pb-20 text-center w-full px-6">
                    <div className="max-w-[95%] mx-auto space-y-12">
                        ...
                        <p className="text-lg md:text-3xl text-neutral-400 max-w-5xl mx-auto leading-relaxed font-medium px-4" style={{ fontSize: `clamp(${styles.heroSubtitleSize * 0.6}px, 2.5vw, ${styles.heroSubtitleSize * (styles.fontScale / 100)}px)` }}>{tHero.subtitle}</p>
                        ...
                        return (
                            <section key={i} style={{ paddingTop: `${styles.sectionSpacing / 10}px`, paddingBottom: `${styles.sectionSpacing / 10}px` }} className="space-y-12 md:space-y-20">
                                <div className="max-w-6xl mx-auto text-center space-y-6 md:space-y-10">
                                    <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter leading-tight px-4" style={{ fontSize: `clamp(${styles.chapterTitleSize * 0.5}px, 5vw, ${styles.chapterTitleSize * (styles.fontScale / 100)}px)` }}>{tChapter.title}</h2>
                                    <p className="text-xl md:text-3xl text-neutral-400 leading-relaxed max-w-4xl mx-auto px-4" style={{ fontSize: `clamp(${styles.chapterDescSize * 0.7}px, 2vw, ${styles.chapterDescSize * (styles.fontScale / 100)}px)` }}>{tChapter.description}</p>
                                </div>
                ...
                <section className="py-20 md:py-60 text-center px-4 md:px-6">
                    <div className="bg-gradient-to-br from-emerald-600/20 via-[#0A0C10] to-cyan-600/20 p-8 md:p-40 border border-white/5 shadow-2xl relative overflow-hidden group" style={{ borderRadius: `${styles.borderRadius * 2}px` }}>
                        ...
                        <h2 className="text-4xl md:text-[8rem] font-black mb-6 md:mb-12 tracking-tighter leading-none relative z-10" style={{ fontSize: `clamp(3rem, 8vw, ${styles.finalCtaTitleSize * (styles.fontScale / 100)}px)` }}>{tFinalCta.title}</h2>
