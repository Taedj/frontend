                        ...
                        >
                            ...
                            <div className="relative group overflow-hidden bg-gradient-to-br from-[#0D1117] to-[#080A0E] border border-white/5 p-12 md:p-24 rounded-[3rem] shadow-2xl">
                                ...
                                <div className="relative z-10 space-y-8 max-w-5xl">
                                    ...
                                    <h1 style={{ fontSize: `clamp(${styles.reportTitleSize * 0.4}px, 5vw, ${styles.reportTitleSize * (styles.fontScale / 100)}px)` }} className="font-black tracking-tighter uppercase italic text-white leading-[0.9]">
                                        {ui.reportTitle}
                                    </h1>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                                    {sections.map((section, idx) => (
                                        ...
                                        >
                                            ...
                                            <div style={{ fontSize: `max(14px, ${styles.reportTextSize * (styles.fontScale / 100)}px)` }} className="relative z-10 prose prose-invert prose-xl max-w-none prose-h1:text-4xl prose-h1:font-black prose-h1:uppercase prose-h1:tracking-tighter prose-h1:text-emerald-500 prose-h1:mb-8 prose-h1:leading-tight prose-h2:text-2xl prose-h2:text-white prose-h2:font-bold prose-h2:mb-6 prose-h2:opacity-80 prose-p:text-[1em] prose-p:leading-relaxed prose-p:font-light prose-li:text-neutral-300 prose-li:text-[0.9em] prose-li:mb-2 prose-strong:text-emerald-400 prose-strong:font-bold">
